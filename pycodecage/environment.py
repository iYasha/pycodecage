...
from pycodecage.factories import InputFactory, PrintFactory, BuiltinsFactory


class TrustedEnvironment:

    def __init__(self, code: str, builtins: BuiltinsFactory = None):
        self.code = code
